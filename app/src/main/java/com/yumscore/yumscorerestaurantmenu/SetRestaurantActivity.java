...
import static com.yumscore.yumscorerestaurantmenu.SplashActivity.SHARED_PREFERENCES_ISOFFLINE;
...
public class SetRestaurantActivity extends AppCompatActivity implements SendAndParseQuickMenuRequest.QuickMenuListener {
    ...
    public void onQuickMenuParsed(Menu menu, String rawMenu) {
        ...
        sharedPreferences.edit().putString(SHARED_PREFERENCES_QUICKID, quickIdUsed).putString(SHARED_PREFERENCES_OFFLINE_MENU, rawMenu).putBoolean(SHARED_PREFERENCES_ISOFFLINE, false).apply();
