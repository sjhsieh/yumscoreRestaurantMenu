...
import static com.yumscore.yumscorerestaurantmenu.MenuVariantsActivity.EXTRA_KEY_LOGO;
import static com.yumscore.yumscorerestaurantmenu.MenuVariantsActivity.EXTRA_KEY_VARIANT;
...
public class MenuExpandableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MenuVariant menuVariant = (MenuVariant) getIntent().getExtras().getSerializable(EXTRA_KEY_VARIANT);
        menuSections = menuVariant.getSections();
        String logoString = (String) getIntent().getExtras().getString(EXTRA_KEY_LOGO);
